...
class Game
{
    ...
    public void Start()
    {
        Console.WriteLine("Character found themselves in an unknown room after a sudden burst of light and was eager to embark on a journey to unravel the mystery of the room.");
        room.PlaceItems();
        room.PlaceNPC();
...
class Room
{
    ...
    public void PlaceItems()
    {
        ...
        items.Add(new Item("watch", "This is a watch, it should be about time.", -2, -1)); // Example placement
        items.Add(new Item("calendar", "Days lost in the fabric of time, memories leave traces on the calendar.", 2, 0)); // Example placement
...
class NPC
{
    ...
    private string riddle = "It runs from yesterday to today, from today to tomorrow. He writes a new story every moment, He works day and night. What is this?";
